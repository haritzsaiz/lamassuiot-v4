...
func RegisterProvider(name CryptoEngineProvider, builder func(*logger.Logger, CryptoEngineConfig) (CryptoEngine, error)) {
	cryptoEngineBuilders[name] = builder
}

func GetProvider(name CryptoEngineProvider) func(*logger.Logger, CryptoEngineConfig) (CryptoEngine, error) {
